...
},{"./jobFormComponent.js":158,"./jobTipsComponent.js":159,"./navigationComponent.js":160,"react":156}],158:[function(require,module,exports){
'use strict';
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				' The purpose of posting a job is to spark a candidates interest in the available postition. When job postings have detailed description, candidates tend to apply to them more.'
			),
			React.createElement(
				'h3',
				null,
			...
			React.createElement(
				...
				' Even though you many not want to give exact compensation, give a range. Make sure to point out any bonuses, commissions, or non-monetary compensation, as well.'
			)
		);
	}
});
